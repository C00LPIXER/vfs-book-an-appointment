...
class Json {
     ...
     * Some names carry a trailing "-VAC" ("…Centre-Kolkata-VAC"), which must come off first or every
     * such centre would be listed as "VAC".
     */
    static String shortCentre(String full) {
        if (full == null) return "";
        String s = full.trim();
        while (s.toUpperCase().endsWith("VAC")) {
